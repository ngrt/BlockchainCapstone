...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Contract is paused. Make sure to change the state before resubmitting");
        _;
    }

    modifier paused() {
        require(_paused == true, "Contract should be paused to execute the call. Make sure to change the state before resubmitting");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) onlyOwner() public {
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(ERC721._exists(tokenId), "Token must exist before setting the URI");
